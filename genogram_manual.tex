...
For instance, use \texttt{\char`\\addTikzGlobalOptions\string{framed\string}} to add a frame to your genogram.
\endgroup
...
\begin{verbatim}
  ...
  \begin{document}
    ...
    \setBeforeDrawing[husband parents distance=12em, couple distance=20em,
                      siblings generation add distance below=-5mm]
    \addTikzGlobalOptions{framed}
    \drawGenogram
  \end{document}
