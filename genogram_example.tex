% Example using version 2.0 of genogram package
...
\begin{document}
    ...
    \addToTikzpicture{%
        \begin{scope}[every node/.style={inner sep=0, inner ysep=1mm, font=\ttfamily\tiny}]
            ...
            \node[text=orange, left = 1mm of gen@child1] {\char`\\son[age=3, name=Tony]};
            \node[text=blue,    right = 1mm of gen@child2] {\char`\\daughter[age=5, name=Pepper]};
